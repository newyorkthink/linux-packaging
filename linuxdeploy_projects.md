...
# 从 GitHub 正式 semver Release 选择、校验并下载唯一的 {version} 资产；DEB 可追加包名和架构统一核对元数据；stdout 返回实际版本
VERSION="$("$SCRIPT_DIR/../common/github/download_latest_stable_release_asset.sh" "<owner/repo>" '<资产名-{version}.扩展名>' "<输出文件>" ["<DEB 包名>" "<DEB 架构>"])"
