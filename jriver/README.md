...
`mediacenter36.AppImage` 从终端启动后 GUI 和简体中文界面正常。终端 Fontconfig 警告来自共享宿主字体配置，未阻止界面。Rofi 无 GUI 的停手结论见第 16 节。详见 [README_runimage_quick.md](./README_runimage_quick.md) 第 9、10 节。

---

## 16. 2026-09-18：Rofi 无 GUI —— 为什么改不了；不改 Rofi

完整证据、失败改动、禁止重复的方向在 [README_runimage_quick.md](./README_runimage_quick.md) 第 10 节。本节只把「改不了什么、为什么」写在本文件里，避免只看旧路线文档的人以为还能靠再改一版包装赌出窗口。
